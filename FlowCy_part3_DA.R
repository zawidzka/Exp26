...
contrastMILvTENK <- createContrast(c(0, 1, 0))
contrastMILvHUNDK <-createContrast(c(0, 0, 1))

contrastBMvLN <- contrastMILvTENK 
contrastBMvTUM <- contrastMILvHUNDK
